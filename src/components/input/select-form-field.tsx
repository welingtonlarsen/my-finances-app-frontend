...
export default function SelectFormField<T extends FieldValues>({form, name, label, type, children, placeholder}: TInputForm<T>) {
    ...
    <FormField
      ...
      render={({ field }) => (
        <FormItem>
          ...
          <Select onValueChange={(value) => onChange(value, field)} defaultValue={field.value}>
            <FormControl>
              <SelectTrigger>
