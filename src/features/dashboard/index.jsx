  ...
  return (
    <Grid2 xs={2} sx={{maxHeight: '100vh', overflowY: 'auto'}}>
      <FormControl sx={{my: '10px', width: '100%' }} size="small">
        <Button onClick={handleAddExpense} sx={{width: '100%'}} variant="contained" color="success" endIcon={<AddIcon />}>Incluir</Button>
      </FormControl>
      <Box sx={{mb: '10px'}}>
        <ExpenseCard amount={200.79} description='Jonnis' paymentMethod='Cartão de crédito' category='Alimentação' installments={1} currentInstallment={1}/>
      </Box>
      <Box sx={{mb: '10px'}}>
        <ExpenseCard amount={200.79} description='Jonnis' paymentMethod='PIX' category='Alimentação' installments={1} currentInstallment={1}/>
      </Box>
      <Box sx={{mb: '10px'}}>
        <ExpenseCard amount={200.79} description='Jonnis' paymentMethod='Cartão de débito' category='Alimentação' installments={1} currentInstallment={1}/>
      </Box>
      <Box sx={{mb: '10px'}}>
        <ExpenseCard amount={200.79} description='Jonnis' paymentMethod='PIX' category='Alimentação' installments={1} currentInstallment={1}/>
      </Box>
...
const SummaryCards = () => {
  return (
    <Grid container>
      <Grid2 sx={{m: '10px'}}>
        <SummaryCard paymentMethod='Cartão de crédito' amount={980.90}/>
      </Grid2>
      <Grid2 sx={{m: '10px'}}>
        <SummaryCard paymentMethod='PIX' amount={300.73}/>
      </Grid2>
      <Grid2 sx={{m: '10px'}}>
        <SummaryCard paymentMethod='Cartão de débito' amount={980.90}/>
      </Grid2>
      <Grid2 sx={{m: '10px'}}>
        <SummaryCard paymentMethod='Dinheiro' amount={980.90}/>
      </Grid2>
    </Grid> 
  )
}
